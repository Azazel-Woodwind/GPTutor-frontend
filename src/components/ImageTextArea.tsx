...
export default function ImageTextArea({
  ...
  return (
    <div className="flex flex-col mb-4">
      ...
      <div className="flex border-[rgb(80,87,110)] border rounded-lg h-[62px] w-full px-1 py-1">
        <div className="text-white border border-[#50576E] h-full px-4 rounded-lg flex items-center cursor-pointer">
