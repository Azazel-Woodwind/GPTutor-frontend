...
/**
 * Icon - A component for displaying different types of icons based on the chat message type.
 * It supports different icon representations for assistant, user, and system messages.
 *
 * @param {Object} props - The component props.
 * @param {string} props.type - The type of icon to display ('assistant', 'user', or 'system').
 * @param {boolean} [props.highlighted] - If true, applies a highlighted style to the icon.
 * @returns {React.Component} An icon component representing different message types.
 */
function Icon({ type, highlighted }) {
    let symbol;
    ...
    return (
        <IconStyle highlighted={highlighted} type={type}>
            {symbol}
        </IconStyle>
    );
}
